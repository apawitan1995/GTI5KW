...
#define SPI_EEP (SPI001_HandleType*)&SPI001_Handle0
#define SPI_UC (SPI001_HandleType*)&SPI001_Handle1
...
extern volatile uint32_t counter_spi;
extern volatile uint32_t tes_spi_addr;
